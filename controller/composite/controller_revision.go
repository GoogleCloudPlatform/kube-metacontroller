...
func (pc *parentController) syncRevisions(parent *unstructured.Unstructured, observedChildren common.ChildMap, relatedObjects common.ChildMap) (parentStatus map[string]interface{}, desiredChildren common.ChildMap, finalized bool, err error) {
